...
export const JobCreateSchema = z.object({
  ...
  employmentTypes: z.string().array().min(1, { message: 'Choose at least one option!' }),
  role: schemaUtils.nullableInput(z.string().min(1, { message: 'Role is required!' }), {
    error: 'Role is required!',
  }),
  skills: z.string().array().min(1, { message: 'Choose at least one option!' }),
  workingSchedule: z.string().array().min(1, { message: 'Choose at least one option!' }),
  locations: z.string().array().min(1, { message: 'Choose at least one option!' }),
  ...
  benefits: z.string().array().min(1, { message: 'Choose at least one option!' }),
  // Not required
  experience: z.string(),
});
